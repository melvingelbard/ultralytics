...
class Model:
    ...
    def __init__(self, model: Union[str, Path] = 'yolov8n.pt', task=None) -> None:
        ...
        self.metrics_gender = None  # validation/training gender metrics
    ...
    def val(self, data=None, validator=None, **kwargs):
        ...
        self.metrics = validator.metrics_age
        self.metrics_gender = validator.metrics_gender

        # TODO Melvin: Actually handle the gender metric validator
        return validator.metrics_age, validator.metrics_gender
