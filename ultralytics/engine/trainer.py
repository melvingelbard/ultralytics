...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        try:
            if self.args.task == 'classify':
                ...
                self.data = check_cls_age_gender_dataset(self.args.data)
    ...
    def _setup_train(self, world_size):
        ...
        if RANK in (-1, 0):
            ...
            metric_keys = self.validator.metrics_age.keys + self.label_loss_items(prefix='val') # TODO Melvin: This is just for Age
