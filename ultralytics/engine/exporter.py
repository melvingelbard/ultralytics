...
from ultralytics.nn.tasks import DetectionModel, SegmentationModel, AgeGenderClassificationModel
...
class Exporter:
    ...
    def __call__(self, model=None):
        ...
        self.metadata = {
            ...
            'task': model.task,
            'batch': -1 if self.args.dynamic else self.args.batch,
            'imgsz': self.imgsz,
    ...
    def export_onnx(self, prefix=colorstr('ONNX:')):
        ...
        output_names = ['output_age', 'output_gender'] if isinstance(self.model, AgeGenderClassificationModel) else output_names
        ...
        if dynamic:
            ...
            elif isinstance(self.model, AgeGenderClassificationModel):
                dynamic['output_age'] = {0: 'batch'}
                dynamic['output_gender'] = {0: 'batch'}

        print("Exporting with args:")
        print("opset_version", opset_version)
        print("input_names", 'input')
        print("output_names", output_names)
        print("dynamic_axes", dynamic or None)
